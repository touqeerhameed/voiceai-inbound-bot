...
import { INBOUND_SERVER_LOG_ENABLED } from '../config/config.js';

const LOG_FILE_PATH = path.resolve('./inboundserver.log'); // or use path.join(process.cwd(), ...)
